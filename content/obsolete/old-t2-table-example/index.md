...
If you haven’t seen my {{<link "old-t1-what-is-vis">}} post, you might want to start there. I usually do this example in lecture, so you may have seen it before.
...
Starting with the 4-step recipe from {{<link page="old-t1-what-is-vis" anchor="How to make a good visualization">}}:
...
I like to think of visualizations as being made up of four components (see {{<link page="old-t1-what-is-vis" anchor="How do we make a design?">}}):
