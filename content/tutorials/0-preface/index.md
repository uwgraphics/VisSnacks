...
This is a preface to a tutorial on the foundations of visualization. The preface provides a summary of the longer documents, and spells out some of the philosophy behind the tutorial explicitly. 

<!--more-->

## The History of this Tutorial

The tutorial is basically a written form of the introductory lectures in my class. It has a long history, and it has evolved - the document kept growing, until I decided it needed to be reorganized (Summer 2026). The last of the original version is still available at {{<link "obsolete/old-t1-what-is-vis">}},
...
([2026 version](https://pages.graphics.cs.wisc.edu/765-26/pages/what-is-this-class/) 
...
This was adapted from my usual first lecture in class - except that it doesn't have as many fun example pictures. However, since lots of people don't get to see that lecture, this tries to get to the main point. And even if you do get to see the lecture, it's a reminder of the key points. And now I use this for class, the the first lectures are less redundant.


## The Key Points of Tutorial 1

**Copied from OLD - Needs updating**
