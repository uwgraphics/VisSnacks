...
The tutorial is basically a written form of the introductory lectures in my class. It has a long history, and it has evolved - the document kept growing, until I decided it needed to be reorganized (Summer 2026). The last of the original versions is still available at {{<link "obsolete/old-t1-what-is-vis">}},
