...
If you need to pick a book to get started, I recommend Alberto Cairo's **The Truthful Art**.

<!--more-->

The question I get asked a lot: if I am going to read a book to get started learning about Vis, which one should I read?

The (very professorial) answer of course, depends on who you are and what you want to learn.

But, after thinking about this for a while, I can actually recommend one as the right first choice for most people: Alberto Cairo's **The Truthful Art** (see my discussion at {{<link cairo>}}). For some people, some other book may actually be better suited for you - but you will probably want to read this one first (or second).

Some of the alternatives...

1. I am limiting myself to picking one book. In my class, I have students use a mix of chapters from different books.
2. If you are a CS graduate student and want to think about visualization in a deep and rigorous manner, {{<link munzner>}} should definitely be high on your list. But you might want to start with Cairo first to get some context.
