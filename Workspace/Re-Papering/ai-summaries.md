# Re-Papering Raw Material: "How AI Summarizes It" Sections

Prepared 2026-07-17 by Claude for the VisSnacks re-papering project. Each section below is intended to be dropped into (or adapted for) a future re-papering page as the "here's what an AI said about it" part. Mike's personal take gets added separately — these are deliberately in the AI's voice, not his.
...
- `PapersSummary/` — one file per paper/post, named `author-year.md`: Cleveland & McGill ×2, Shneiderman, Amar, Brehmer & Munzner (Multi-Level Typology of Abstract Visualization Tasks), Problem Space, Mackinlay, Bertini, North, Rind et al. (Task Cube), Schulz et al. (A Design Space of Visualization Tasks), Card/Mackinlay/Shneiderman, Shmueli, Leek & Peng, Zgraggen et al., Franconeri et al. (Science of Visual Data Communication), Viégas & Wattenberg (Design and Redesign), Heimerl et al. (Binned Aggregation of Multi-Class Scatterplots), Sarikaya & Gleicher (Scatterplots: Tasks, Data, and Designs) — all done. See `PapersSummary/README.md`.
